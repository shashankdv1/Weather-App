...
function App() {
    const [temp, setTemp] = useState("Enter Temperature");
    ...
    useEffect(() => {
        if (myData?.main?.temp != null) {
            setTemp(Math.round(myData.main.temp - 273));
        }
    }, [myData]);
